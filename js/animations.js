(function () {
  ...
  */
  ...
  var gsap,
    ...
    _stretchToFitSpecialChars = function _stretchToFitSpecialChars(collection, specialCharsRegEx) {
      if (specialCharsRegEx) {
        ...
        if (charsFound.size) {
          while (--i > -1) {
            word = collection[i];
            var _iterator = _createForOfIteratorHelper(charsFound),
              _step;
            try {
    ...
    _splitWordsAndCharsRecursively2 = function _splitWordsAndCharsRecursively(element, config, wordWrapper, charWrapper, prepForCharsOnly, deepSlice, ignore, charSplitRegEx, specialCharsRegEx, isNested) {
      var _a;
      var nodes = Array.from(element.childNodes),
        ...
        lastWordText,
        k;
      if (_typeof(wordDelimiter) === "object") {
        ...
        if (curNode.nodeType === 3) {
          ...
          for (j = 1; j <= words.length; j++) {
            ...
            if (!reduceWhiteSpace && wordText === "") {
              ...
              if (charWrapper) {
                curWordChars = _charSegmenter ? _stretchToFitSpecialChars(_toConsumableArray(_charSegmenter.segment(wordText)).map(function (s) {
                  return s.segment;
  ...
  var _SplitText = /*#__PURE__*/function () {
    function _SplitText(elements, config) {
      var _this = this;
      _classCallCheck(this, _SplitText);
      this.isSplit = false;
      _initIfNecessary();
    ...
    return _createClass$1(_SplitText, [{
      key: "split",
      value: function split(config) {
        var _this2 = this;
        ...
        if (splitCharacters || splitWords || splitLines) {
          ...
          this.elements.forEach(function (element, index) {
            ...
            var chars = [],
              ...
              smartWrapSpan,
              nextSibling;
            _splitWordsAndCharsRecursively2(element, config, wordWrapper, charWrapper, onlySplitCharacters, deepSlice && (splitLines || onlySplitCharacters), ignore, finalCharSplitRegEx, specialCharsRegEx, false);
            if (splitLines) {
              ...
              for (i = 0; i < words.length; i++) {
                ...
                if (splitCharacters || !curWord.nextSibling || curWord.nextSibling.nodeType !== 3) {
                  if (smartWrap && !splitLines) {
                    ...
                    var _curWord;
                    (_curWord = curWord).replaceWith.apply(_curWord, _toConsumableArray(curWord.childNodes));
                  }
                } else {
          ...
          mask && this[mask] && (_this$masks = this.masks).push.apply(_this$masks, _toConsumableArray(this[mask].map(function (el) {
      ...
      key: "create",
      value: function create(elements, config) {
